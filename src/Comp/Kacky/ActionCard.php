...
class ActionCard {
   ...
   */
	...
	const DVOJITA_HROZBA = 1; // OK
	const DVOJITA_TREFA = 2; // OK
	const KACHNI_TANEC = 3; // OK
	const TURBOKACHNA = 4; // OK
	const ZIVY_STIT = 5; // OK
	const ROSAMBO = 6; // OK
	const STRILEJ_VLEVO = 7; // OK
	const STRILEJ_VPRAVO = 8; // OK
	const JEJDA_VEDLE = 9; // OK
	const KACHNI_UNIK = 10; // OK
	const LEHARO = 11; // OK
	const CHVATAM = 12; // OK
	const KACHNI_POCHOD = 13; // OK
	const ZAMIRIT = 14; // OK
	const VYSTRELIT = 15; // OK
